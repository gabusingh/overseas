export const countryCodeList = [
  ...
  { name: "Cocos (Keeling) Islands", code: "CC", dialCode: "+672" },
  ...
  { name: "Heard Island & McDonald Islands", code: "HM", dialCode: "+0" },
  { name: "Holy See (Vatican City State)", code: "VA", dialCode: "+39" },
  ...
  { name: "Palestinian Territory", code: "PS", dialCode: "+970" },
  ...
  { name: "Viet Nam", code: "VN", dialCode: "+84" },
